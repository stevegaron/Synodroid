...
public class OTPRequestException extends Exception {
	 ...
	 * @param msgP
	 */
	public OTPRequestException(String jsonReasonP) {
		super();
	 ...
	 * @param msgP
	 */
	public OTPRequestException(int idP) {
		super();
		id = idP;
		isIDException = true;
	}
	 ...
	 * @param msgP
	 */
	public OTPRequestException(Exception rootCauseP) {
		super();
